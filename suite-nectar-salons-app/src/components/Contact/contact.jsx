        ...
        <div className='formBackroung-wrapper'>
          ...
          <div className='operationHrs'>
            <div className='col-6'>
              ...
              <ui>
                <p className='oppHours'>Sunday - 8:00 am - 8:00 pm</p>
                <p className='oppHours'>Monday - 9:00 am - 7:00 pm</p>
                <p className='oppHours'>Tuesday - 9:00 am - 7:00 pm</p>
                <p className='oppHours'>Wednesday - 9:00 am - 7:00 pm</p>
                <p className='oppHours'>Thursday - 9:00 am - 7:00 pm</p>
                <p className='oppHours'>Friday - 9:00 am - 7:00 pm</p>
                <p className='oppHours'>Saturday - 8:00 am - 8:00 pm</p>
